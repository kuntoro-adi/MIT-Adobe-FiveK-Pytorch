...
# Log file
log_file = "file_name, split, width, height, width_n, height_n\n"
counter = 0
...
for root, dirs, files in os.walk(DATASET_DIR):
    for file_name in files:
        ...
        if file_name.endswith('.dng'):
            ...
            width_n, height_n = int(int(width / 1) * 1), int(int(height / 1) * 1) # the original size
            ...
            print()
            log_file += "{},{},{},{},{},{}\n".format(file_name, split, str(width), str(height), str(width_n), str(height_n))
            counter += 1
